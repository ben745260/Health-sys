...
class HealthData(models.Model):
    ...
    data_bloodPressure_sys = models.FloatField(max_length=32)
    data_bloodPressure_dia = models.FloatField(max_length=32)
    ...
    def __str__(self):
        return f"{self.id}: {self.saveDate} Remark:{self.remark} | {self.data_temperature}, {self.data_heartBeat}, {self.data_bloodPressure_sys}/{self.data_bloodPressure_dia}"